"""A different, independently-designed reasonable heuristic: pure
earliest-deadline-first, no scarcity awareness, but does avoid assigning
a fatigued technician when a rested one is free and qualified."""
